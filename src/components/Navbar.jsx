...
const Navbar = () => {
 ...
 const handleLogOut = () => {
  ...
  return (
        ...
        <div className="navbar bg-white max-w-screen-2xl container mx-auto px-5  ">
  ...
  <div className="navbar-center  hidden lg:flex ">
    <ul className="menu menu-horizontal px-1 text-gray-800">
      ...
      <li>
        <details>
          <summary>Categories</summary>
          <ul className="p-2 text-white z-50">
            <li><Link to={'/'}>Web Design</Link></li>
            <li><Link to={'/'}>App Development</Link></li>
            <li><Link to={'/'}>UI/UX Design</Link></li>
            <li><Link to={'/'}>Digital Marketing</Link></li>
  ...
  {
                    user ? (<><Link to="/dashboard" className="btn btn-outline btn-primary px-8 sm:flex">Dashboard</Link>
                        <button onClick={handleLogOut}  className="btn  btn-primary bg-primary text-white">Logout</button></>) : (<><Link to="/login" className="btn btn-outline btn-primary px-8  sm:flex">Log In</Link>
                            <Link to="/price" className="btn  btn-primary bg-primary text-white">Start Free Trial</Link></>)
                }
